            ...
            <div class="row">
                <div class="col-md-12 col-lg-8">
                    ...
                    <div class="row ">
                        ...
                        @if($loop->index <=1) <div class="col-sm-12 col-md-6 mb-4">
                            <!-- Post Article -->
                ...
                <div class="row ">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="wrapp__list__article-responsive">
                            ...
                            @if($loop->index >1 && $loop->index <=3) <div class="mb-3">
                                <!-- Post Article -->
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="wrapp__list__article-responsive">
                        @foreach ($recentNews as $news )
                        @if($loop->index >3 && $loop->index <=5) <div class="mb-3">
                            <!-- Post Article -->
                            <div class="card__post card__post-list">
                                <div class="image-sm">
                                    <a href="{{ route('news-detail', $news->slug) }}">
                    ...
                    <aside class="wrapper__list__article mb-0">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                @if ($loop->index <=2) <div class="mb-4">
                                    <!-- Post Article -->
                                    <div class="article__entry">
                                        <div class="article__image">
                        ...
                        <div class="col-md-6">
                            ...
                            @if ($loop->index >2 && $loop->index <=5 ) <div class="mb-4">
                                <!-- Post Article -->
                                <div class="article__entry">
                                    <div class="article__image">
                                        <a href="{{ route('news-detail' , $sectionThree->slug) }}">
